...
"use strict";
var CodeMirror = require('./ace/ace.js');
	...
	if(is_code === "single") {
		...
		if(cur_start.line !== cur_end.line || cur_start.ch !== cur_end.ch) {
			...
			if(block_end === undefined) {
				lineCount = cm.document.getLength();
...
SimpleMDE.prototype.createToolbar = function(items) {
	...
	var cmWrapper = cm.renderer.getContainerElement();
	...
	for(i = 0; i < status.length; i++) {
		...
		if(typeof status[i] === "object") {
			...
			if(name === "words") {
				...
				defaultValue = function(el) {
					// console.log(cm.env.document.getLength());
					el.innerHTML = cm.env.document.getLength();
				};
				onUpdate = function(el) {
					el.innerHTML = cm.env.document.getLength();
				};
